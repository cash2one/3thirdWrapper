#ifndef _WRAPPER_MYSQL_H_
#define _WRAPPER_MYSQL_H_
...
int  TLib_DB_SetDB(TLIB_DB_LINK *pstDBLink, const char *sHostAddress, const char *sUserName, const char *sPassword, const char *sDBName, int iDbport, char *sErrMsg);
